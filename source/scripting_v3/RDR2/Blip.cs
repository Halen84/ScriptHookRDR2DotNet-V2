...
namespace RDR2
{
	public sealed class Blip : PoolObject, IEquatable<Blip>
	{
		...
		public void RemoveModifier(eBlipModifier modifier)
		{
	...
	public enum eBlipStyle : uint
	{

	}

	public enum eBlipModifier : uint
	{
